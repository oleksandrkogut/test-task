...
class TestMockHttpClient extends MockHttpClient
{
    private string $baseUri = 'https://test.com';

    public function __construct()
    {
        parent::__construct($this->handleRequests(...), $this->baseUri);
    }
    ...
    {
        if ($method === 'GET' && $url === 'http://exchangerates.api/v1/latest?access_key=key') {
            return $this->getExchangeRatesResponse();
        }

        if ($method === 'GET' && str_starts_with($url, 'https://binlist.api')) {
            return $this->getBinDetails($url);
        }
     ...
     * @return MockResponse
     */
    private function getBinDetails(string $url): MockResponse
    {
        $body = match ($url) {
            'https://binlist.api/45717360' => '{"number":{},"scheme":"visa","type":"debit","brand":"Visa Classic","country":{"numeric":"208","alpha2":"DK","name":"Denmark","emoji":"🇩🇰","currency":"DKK","latitude":56,"longitude":10},"bank":{"name":"Jyske Bank A/S"}}',
            'https://binlist.api/516793' => '{"number":{},"scheme":"mastercard","type":"debit","brand":"Debit Mastercard","country":{"numeric":"440","alpha2":"LT","name":"Lithuania","emoji":"🇱🇹","currency":"EUR","latitude":56,"longitude":24},"bank":{"name":"Swedbank Ab"}}',
            'https://binlist.api/41417360' => '{"number": null, "country": {}, "bank": {}}',
            'https://binlist.api/45417360' => '{"number":{},"scheme":"visa","type":"credit","brand":"Visa Classic","country":{"numeric":"392","alpha2":"JP","name":"Japan","emoji":"🇯🇵","currency":"JPY","latitude":36,"longitude":138},"bank":{"name":"Credit Saison Co., Ltd."}}',
            'https://binlist.api/4745030' => '{"number":{},"scheme":"visa","type":"debit","brand":"Visa Classic","country":{"numeric":"440","alpha2":"LT","name":"Lithuania","emoji":"🇱🇹","currency":"EUR","latitude":56,"longitude":24},"bank":{"name":"Uab Finansines Paslaugos Contis"}}',
            default => throw new UnexpectedValueException(sprintf(
                'Mock binlist not implemented: %s',
                $url
            ))
        };
     ...
     * @return MockResponse
     */
    private function getExchangeRatesResponse(): MockResponse
    {
        return new MockResponse(
